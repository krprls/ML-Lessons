...
public class MoodProject1_4 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = { "sentence"};

	private String[] defaultValues = { "I am happy"};
	...
	public MoodProject1_4(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("ML to guess how you are feeling!");
	...
	public static void main(String[] args) {
		MoodProject1_4 Mood = new MoodProject1_4(0, 0, 1600, 600);
