...
public class HeartDiseaseProject1 extends JFrame implements ActionListener{

	private JPanel contentPane;
	private String[] labelNames = {"age","sex","cp","trestbps","chol","fbs",
			   "restecg","thalach","exang","oldpeak","slop","ca","thal"};
	
	private String[] defaultValues = {"37","1","3","130","250","0",
			   "0","187","0","3.5","3","0","3"};
	...
	public HeartDiseaseProject1(int x, int y, int width, int height){
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("Heart Disease Prediction Service");
	...
	public static void main(String[] args) {
		HeartDiseaseProject1 heartDisease = new HeartDiseaseProject1(0, 0, 400, 400);
		heartDisease.generatePanelContent();
