...
public class AdClicksProject1 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = {"Daily Time Spent on Site", "Age", "Area Income","Daily Internet Usage","Ad Topic Line","City",
              "Male", "Country", "Timestamp"};

	private String[] defaultValues = { "68.95", "35", "61833.9", "256.09", "Cloned 5thgeneration orchestration", "Wrightburgh", "0", "Tunisia", "2016-03-27 00:53:11" };
	...
	public AdClicksProject1(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("Ad Click Prediction Service");
