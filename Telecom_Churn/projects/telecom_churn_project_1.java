...
public class TelecomChurnProject1 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = {"gender", "SeniorCitizen" , "Partner" , "Dependents" , "tenure", "PhoneService",
    "MultipleLines" , "InternetService" , "OnlineSecurity", "OnlineBackup", "DeviceProtection", "TechSupport",
    "StreamingTV" , "StreamingMovies" , "Contract" , "PaperlessBilling" , "PaymentMethod" , "MonthlyCharges" , "TotalCharges"};

	private String[] defaultValues = {"Male","0","No","No","34","Yes","No","DSL","Yes","No","Yes","No","No","No","One year","No","Mailed check","56.95","1889.5"};
	...
	public TelecomChurnProject1(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("Telecom Churn Prediction Service");
	...
	public static void main(String[] args) {
		TelecomChurnProject1 telecomChurn = new TelecomChurnProject1(0, 0, 400, 400);
		telecomChurn.generatePanelContent();
		telecomChurn.setVisible(true);
	}
