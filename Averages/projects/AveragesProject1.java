...
public class AveragesProject1 extends JFrame implements ActionListener {
	...
	public AveragesProject1(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public static void main(String[] args) {
		AveragesProject1 Averages = new AveragesProject1(0, 0, 1600, 600);
