...
def ui_mode():
    ...
    layout = [[sg.Text('url'), sg.Input('', key='url')],
              ...
              [sg.Text('<1H OCEAN'), sg.Input(0, key='<1H OCEAN')],
              [sg.Text('INLAND'), sg.Input(0, key='INLAND')],
              [sg.Text('ISLAND'), sg.Input(0, key='ISLAND')],
              [sg.Text('NEAR BAY'), sg.Input(1, key='NEAR BAY')],
              [sg.Text('NEAR OCEAN'), sg.Input(0, key='NEAR OCEAN')],
