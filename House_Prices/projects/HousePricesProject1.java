...
public class HousePricesProject1 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = { "longitude", "latitude", "housing_median_age", "total_rooms", "total_bedrooms",
			"population", "households", "median_income" };

	private String[] defaultValues = { "-122.5", "37.79", "52", "8", "1", "13", "1", "15.0001" };
	...
	public HousePricesProject1(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("House Prices Prediction Service (Project 1)");
	...
	public static void main(String[] args) {
		HousePricesProject1 housePrices = new HousePricesProject1(0, 0, 400, 400);
		housePrices.generatePanelContent();
		housePrices.setVisible(true);
	}
