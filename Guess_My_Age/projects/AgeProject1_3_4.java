...
public class AgeProject1_3_4 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = { "num_countries", "years_school", "height"};

	private String[] defaultValues = { "48", "2", "5.14"};
	...
	public AgeProject1_3_4(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	private void generatePanelContent() {
		...
		setTitle("ML to guess whether you are a child or an adult!");
	...
	public static void main(String[] args) {
		AgeProject1_3_4 Mood = new AgeProject1_3_4(0, 0, 1600, 600);
		Mood.generatePanelContent();
