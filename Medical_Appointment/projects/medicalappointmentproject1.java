...
public class medicalappointmentproject1 extends JFrame implements ActionListener {

	private JPanel contentPane;
	private String[] labelNames = { "PatientId", "AppointmentID", "Gender", "Age", "Scholarship", "Hipertension",
			"Diabetes", "Alcoholism", "Handcap", "SMS_received" };

	private String[] defaultValues = { "867951000000", "5642828", "F", "8", "0", "0", "0", "0", "0", "0" };
	...
	public medicalappointmentproject1(int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public static void main(String[] args) {
		medicalappointmentproject1 medicalappointment = new medicalappointmentproject1(0, 0, 400, 400);
		medicalappointment.generatePanelContent();
